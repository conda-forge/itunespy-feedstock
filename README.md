...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/itunespy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15056&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/itunespy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `itunespy` can be installed with:

```
conda install itunespy
```

It is possible to list all of the versions of `itunespy` available on your platform with:
